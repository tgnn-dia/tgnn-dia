...
class NAT(torch.nn.Module):
    def __init__(self, n_feat, e_feat, output_dim, time_dim=2, num_neighbors=['1', '32'], dropout=0.1,
                 n_hops=2, ngh_dim=4, device=None):
        ...
        # output of gat is num_features_per_layer[-1] * num_heads_per_layer[-1]
        # num_heads_per_layer will be padded to [1] + num_heads_per_layer
        self.gat = GAT(1, [2], [self.attn_dim, self.output_dim], add_skip_connection=False, bias=True,
