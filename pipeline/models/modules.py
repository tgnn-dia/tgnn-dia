...
class LinearTimeEncoder(nn.Module):
    """
    Linear time encoder from Chung et al. (2025): Φ(Δt) = W·Δt + b.
    Avoids the information loss of sinusoidal many-to-one mappings while
    remaining compatible with self-attention (see Theorem 3.1 in the paper).
    """
